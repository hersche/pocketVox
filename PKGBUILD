...
groups=()
depends=('gstreamer')
makedepends=('gtk-doc' 'intltool' 'autoconf' 'binutils' 'git' 'glib2' 'gobject-introspection' 'gobject-introspection-runtime' 'espeak' 'bison' 'python2' 'libnotify' 'gst-plugins-base' 'gtk3' 'gtk-doc' ) 
checkdepends=()
optdepends=()
provides=()
conflicts=()
